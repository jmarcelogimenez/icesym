...
Simulator['folder_name']	= 'ctest6'
Simulator['filein_state']	= 'ctest6_state.dat'
Simulator['filesave_state']	= 'ctest6_state.dat'
Simulator['calc_power'] = 1
Simulator['calc_IMEP'] = 1
Simulator['calc_torque'] = 1
Simulator['calc_SFC'] = 1
Simulator['calc_indicated'] = 1
Simulator['calc_effective'] = 1
